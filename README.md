...
command will obtain an initial certificate and start a long-running process to
automatically renew the certificate when needed.
...
ICT. See the [acme-buddy][acme-buddy] docs for more details about the file's
expected format.
